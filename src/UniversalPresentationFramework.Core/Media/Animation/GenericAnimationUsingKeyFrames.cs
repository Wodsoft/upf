...
namespace Wodsoft.UI.Media.Animation
{
    ...
    public abstract class GenericAnimationUsingKeyFrames<TValue, TKeyFrame, TKeyFrameCollection> : GenericAnimationBase<TValue>, IAddChild
        ...
        where TKeyFrameCollection : KeyFrameCollection<TKeyFrame>, IHaveEmpty<TKeyFrameCollection>, new()
    {
        ...
        /// <Summary>
        /// Creates a new GenericAnimationUsingKeyFrames.
        /// </Summary>
        public GenericAnimationUsingKeyFrames()
            : base()
        {
        ...
        {
            GenericAnimationUsingKeyFrames<TValue, TKeyFrame, TKeyFrameCollection> sourceAnimation = (GenericAnimationUsingKeyFrames<TValue, TKeyFrame, TKeyFrameCollection>)sourceFreezable;
        ...
        {
            GenericAnimationUsingKeyFrames<TValue, TKeyFrame, TKeyFrameCollection> sourceAnimation = (GenericAnimationUsingKeyFrames<TValue, TKeyFrame, TKeyFrameCollection>)source;
        ...
        private void CopyCommon(GenericAnimationUsingKeyFrames<TValue, TKeyFrame, TKeyFrameCollection> sourceAnimation, bool isCurrentValueClone)
        {
