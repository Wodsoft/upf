    ...
    public class ModifierKeysConverter : TypeConverter
    {
                ...
                else
                {
                    ...
                    if ((modifiers & ModifierKeys.Alt) == ModifierKeys.Alt)
                    {
                        if (strModifiers.Length > 0)
                            strModifiers += _Modifier_Delimiter;
        ...
        private ModifierKeys GetModifierKeys(string modifiersToken, CultureInfo culture)
        {
            ...
            if (modifiersToken.Length != 0)
            {
                ...
                do
                {
                    offset = modifiersToken.IndexOf(_Modifier_Delimiter);
        ...
        {
            return (modifierKeys == ModifierKeys.None || (((int)modifierKeys & ~((int)_ModifierKeysFlag)) == 0));
        }

        private const char _Modifier_Delimiter = '+';

        private static ModifierKeys _ModifierKeysFlag = ModifierKeys.Windows | ModifierKeys.Shift |
