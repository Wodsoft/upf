    ...
    public struct FontStretch : IFormattable
    {
        ...
        public static FontStretch FromOpenTypeStretch(int stretchValue)
        {
            if (stretchValue < 1 || stretchValue > 9)
                throw new ArgumentOutOfRangeException("stretchValue", "Value must between 1 and 9.");
        ...
        private string ConvertToString(string? format, IFormatProvider? provider)
        {
            ...
            FontStretches.FontStretchToString(RealStretch, out convertedValue);
