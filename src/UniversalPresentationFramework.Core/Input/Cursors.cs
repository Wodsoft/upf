...
namespace Wodsoft.UI.Input
{
    ...
    public static class Cursors
    {
        ...
        internal static Cursor EnsureCursor(CursorType cursorType)
        {
            ...
            if (_StockCursors[index] == null)
                _StockCursors[index] = new Cursor(cursorType);
            return _StockCursors[index];
        }

        private static Cursor[] _StockCursors = new Cursor[(int)CursorType.Custom];  //CursorType.ArrowCD = 27
    }
}
