    ...
    public class SingleAnimation : SingleAnimationBase
    {
        ...
        static SingleAnimation()
        {
            ...
            FromProperty = DependencyProperty.Register(
                ...
                typeofProp,
                typeofThis,
                new PropertyMetadata((float?)null, propCallback),
                validateCallback);
        ...
        /// float property from its base value to the value specified
        ...
        /// <summary>
        /// Creates a new SingleAnimation that will animate a
        /// float property from the "fromValue" parameter of this constructor
        ...
        protected override float GetCurrentValueCore(float defaultOriginValue, float defaultDestinationValue, AnimationClock animationClock)
        {
            ...
            double progress = animationClock.CurrentProgress;
            ...
            float to = new float();
            float accumulated = new float();
            float foundation = new float();
            ...
            if (IsCumulative)
            {
                ...
                {
                    float accumulator = AnimatedTypeHelpers.SubtractSingle(to, from);
        ...
        private static bool IsValidAnimationValueSingle(float value)
        {
        ...
        private static bool ValidateFromToOrByValue(object? value)
        {
            ...
            {
                return IsValidAnimationValueSingle(typedValue.Value);
            }
            else
            {
                return true;
