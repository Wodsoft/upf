    ...
    public class CornerRadiusConverter : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext? typeDescriptorContext, CultureInfo? cultureInfo, object source)
        {
            if (source != null)
            {
                ...
                else { return new CornerRadius(Convert.ToSingle(source, cultureInfo)); }
            }
...
#pragma warning disable 56506
        ...
        public override object ConvertTo(ITypeDescriptorContext? typeDescriptorContext, CultureInfo? cultureInfo, object? value, Type destinationType)
        {
            ...
            {
                throw new ArgumentException($"Unexpected parameter type \"{value.GetType().FullName}\".", "value");
            }
            ...
            if (destinationType == typeof(InstanceDescriptor))
            {
                ConstructorInfo ci = typeof(CornerRadius).GetConstructor(new Type[] { typeof(float), typeof(float), typeof(float), typeof(float) })!;
                return new InstanceDescriptor(ci, new object[] { cr.TopLeft, cr.TopRight, cr.BottomRight, cr.BottomLeft });
            }

            throw new ArgumentException($"Can not convert type to \"{destinationType.FullName}\".");
        }
...
#pragma warning restore 56506
        ...
        static internal CornerRadius FromString(string s, CultureInfo? cultureInfo)
        {
            ...
            while (th.NextToken())
            {
                ...
                radii[i] = float.Parse(th.GetCurrentToken()!, cultureInfo);
                i++;
            }
            ...
            throw new FormatException($"Invalid corner radius string \"{s}\".");
        }
        #endregion
    }
}
